...
| `TRUST_PROXY`                           | `172.30.0.2` in bundled Compose     | Exact reverse-proxy IP/CIDR trusted for forwarded client headers; leave unset/fail-closed when not behind a known proxy.                       |
